# The "Flavor Dream" Master Template: Satellite Surrealism (v2.6)
...
**The Vista:** A **vast, sprawling aerial vista** of **[City, Country]**, rendered with the immense scale and perspective of a **3D satellite map**. The landscape must be **geographically accurate**, featuring a dense, realistic grid of streets and specific landmarks like **[Landmark 1]** and **[Landmark 2]**.

**The Anomalies:**
* **Primary:** One colossal, city-sized, hyper-detailed **[User-Selected Primary Ingredient]** hovers high in the stratosphere in a **three-quarters off-center position** to break vertical symmetry.
* **Secondary:** Large **[Remaining Ingredients]** drift at varying altitudes like massive moons.
* **Lighting & Shadows:** All floating objects must cast **soft, semi-translucent, and diffused shadows** onto the city blocks below. Shadows should communicate immense scale without obscuring the urban grid in high-contrast black.

**The Palette (National-Culinary Sync):**
* The color scheme is a luminous blend of **[Ingredient Colors]** and **[National Colors]**.
* **Atmosphere:** Pastel gradients of **[Color 1, Color 2]** in the cloudscape.
* **Geographic Feature:** Iconic features like **[Sea/Mountain/River]** must retain their **natural, gorgeous colors** (e.g., Aegean Blue or Caribbean Turquoise) to anchor the surrealism in reality.

**The Atmosphere:** Small, stylized flying **[Local Vehicle Type]** move among the clouds. **[Texture/Botanical Elements]** drift through the air like cosmic dust.
